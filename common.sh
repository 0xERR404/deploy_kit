...
#
# ВАЖНО (архитектура с NEXUS404 Hub): поддоменов на отдельные сервисы
...
#
# В архитектуре NEXUS404 Hub этой модели больше нет:
...
#     весь auth_gate.
#   - Единственная внешняя точка входа — сам хаб (NEXUS404 Hub), и
...
# корневым доменом. В архитектуре NEXUS404 Hub это НЕ "один из
...
#   - сам хаб NEXUS404 Hub — обработчик "по умолчанию" (path="")
...
# =============================================================================
# Общее для NEXUS404 Hub — нашего хаба, замены Homer (используется
...
# который читает фронтенд NEXUS404 Hub. add_hub_card не парсит и не
...
# NEXUS404 Hub — своя статика/бэкенд, конфиг подхватывается при
